...
export default class Form extends React.Component {
	...
	onMouseEnter() {
		this.setState(previousState => ({
			entrei: previousState.entrei + 1,
		}));
		if(this.state.entrei === 0) alert('Preencha com cuidado esta informação');
	}
			...
			<form>
				...
				<fieldset>
					<label htmlFor="resumo">
						Faça um resumo do seu cúrriculo:
						<TextArea name="resumo" id="resumo" maxLength="1000" required={ true } />
					</label>
					<label htmlFor="cargo">
						Cargo: 
						<TextArea name="cargo" id="cargo" required={ true } maxLength="40" mouseOver={ this.onMouseEnter } value={ this.state.entrei } />
					</label>
				</fieldset>
			</form>
		);
